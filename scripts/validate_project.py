...
REQUIRED_FILES = [
    ...
    "docs/07-production-web-app-foundation.md",
    ...
    "scripts/capture_evidence_ux_snapshot.py",
    ...
    "src/jp_lms_vibeops/__main__.py",
    "src/jp_lms_vibeops/cli.py",
    ...
    "specs/json-schema/event.schema.json",
    "specs/json-schema/xai-card.schema.json",
    "specs/json-schema/approval.schema.json",
    "specs/json-schema/measurement-plan.schema.json",
    "specs/json-schema/measurement-result.schema.json",
    "specs/json-schema/impact-ledger.schema.json",
    "specs/json-schema/ai-operation.schema.json",
    "specs/json-schema/lms-adapter.schema.json",
    ...
    "docs/evidence-ux/snapshots/operations-home.png",
]
...
def run_runtime_checks() -> None:
    commands = [
        ...
        [sys.executable, "scripts/validate_web_app.py"],
        [sys.executable, "scripts/validate_screenshots.py"],
        [sys.executable, "scripts/validate_packaging.py"],
        [sys.executable, "scripts/validate_formal_schemas.py"],
